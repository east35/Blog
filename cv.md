...
Before that, I helped Credit Karma grow their design team from 6 to 30+ designers, launched Facebook's F8 developer conference, built the first American design team at Volvo Cars, and explored how AI will reshape Dell's product ecosystem over the next decade.
...
|**Enterprise** | **Startups & Growth-Stage** |
|---|---|
| athenaHealth | Teamwork Online |
| ByteDance | Search Nurture |
| Volvo Cars | Autoreach |
| CreditKarma | Slush Conference |
| Facebook | Detour |
| Dell | Keet Health |
| Electronic Arts | Banter |
| CapitalOne | Grammarly |
| Paypal | Pingboard |
| Indeed | Ensa |
| OpenTable | MakeCreate |
| | CriticalStack |
| | Drop-off |
| | MapMyBeauty |
| | Sudden Coffee |
